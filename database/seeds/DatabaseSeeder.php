        ...
        for ($i = 1; $i <= $jml_pertemuan; $i++) {
            ...
            for ($j = 1; $j <= $faker->numberBetween(10, $jml_max_soal); $j++) {
                DB::table('latihan')->insert([
                    ...
                    'E' => $faker->sentence($nbWords = $faker->numberBetween(1, 3), $variableNbWords = true),
                    'jawaban' => $jawaban[array_rand($jawaban, 1)],
                    'jawaban_lengkap' => $faker->sentence($nbWords = $faker->numberBetween(1, 3), $variableNbWords = true),
                ]);
                $id_latihan++;
            }
