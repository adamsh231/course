            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ URL::asset('quixlab/images/users/8.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ URL::asset('quixlab/images/users/5.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ URL::asset('quixlab/images/users/7.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ URL::asset('quixlab/images/users/1.jpg') }}" class="rounded-circle" alt="">
                        ...
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ URL::asset('quixlab/images/avatar/1.jpg') }}" class="mr-3 rounded-circle">
                                ...
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ URL::asset('quixlab/images/avatar/2.jpg') }}" class="mr-3 rounded-circle">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="35" src="{{ URL::asset('quixlab/images/avatar/3.jpg') }}" class="mr-3 rounded-circle">
                                    <div class="media-body">
